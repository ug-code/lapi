...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\project-git\lapi\public\storage' => 'string',
            'jwt.secret' => 'string',
            ...
            'request-docs.title' => 'string',
            'request-docs.enabled' => 'boolean',
            'request-docs.debug' => 'boolean',
            'request-docs.url' => 'string',
            'request-docs.middlewares' => 'array',
            'request-docs.only_route_uri_start_with' => 'string',
            'request-docs.hide_matching' => 'array',
            'request-docs.hide_meta_data' => 'boolean',
            'request-docs.hide_sql_data' => 'boolean',
            'request-docs.hide_logs_data' => 'boolean',
            'request-docs.hide_models_data' => 'boolean',
            'request-docs.rules_methods' => 'array',
            'request-docs.default_responses' => 'array',
            'request-docs.default_headers.Content-Type' => 'string',
            'request-docs.default_headers.Accept' => 'string',
            'request-docs.group_by.uri_patterns' => 'array',
            'request-docs.open_api.title' => 'string',
            'request-docs.open_api.description' => 'string',
            'request-docs.open_api.version' => 'string',
            'request-docs.open_api.document_version' => 'string',
            'request-docs.open_api.license' => 'string',
            'request-docs.open_api.license_url' => 'string',
            'request-docs.open_api.server_url' => 'string',
            'request-docs.open_api.delete_with_body' => 'boolean',
            'request-docs.open_api.exclude_http_methods' => 'array',
            'request-docs.open_api.responses.200.description' => 'string',
            'request-docs.open_api.responses.200.content.application/json.schema.type' => 'string',
            'request-docs.open_api.responses.400.description' => 'string',
            'request-docs.open_api.responses.400.content.application/json.schema.type' => 'string',
            'request-docs.open_api.responses.401.description' => 'string',
            'request-docs.open_api.responses.401.content.application/json.schema.type' => 'string',
            'request-docs.open_api.responses.403.description' => 'string',
            'request-docs.open_api.responses.403.content.application/json.schema.type' => 'string',
            'request-docs.open_api.responses.404.description' => 'string',
            'request-docs.open_api.responses.404.content.application/json.schema.type' => 'string',
            'request-docs.open_api.responses.422.description' => 'string',
            'request-docs.open_api.responses.422.content.application/json.schema.type' => 'string',
            'request-docs.open_api.responses.500.description' => 'string',
            'request-docs.open_api.responses.500.content.application/json.schema.type' => 'string',
            'request-docs.open_api.responses.default.description' => 'string',
            'request-docs.open_api.responses.default.content.application/json.schema.type' => 'string',
            'request-docs.open_api.security.type' => 'string',
            'request-docs.open_api.security.name' => 'string',
            'request-docs.open_api.security.position' => 'string',
            'request-docs.export_path' => 'string',
            ...
            'app-logger.http.enabled' => 'boolean',
            'app-logger.http.log_profile' => 'string',
            'app-logger.http.log_writer' => 'string',
            'app-logger.http.should_log' => 'array',
            'app-logger.http.except' => 'array',
            'app-logger.http.channel' => 'NULL',
            'app-logger.performance.enabled' => 'boolean',
            'app-logger.performance.log_profile' => 'string',
            'app-logger.performance.log_writer' => 'string',
            'app-logger.performance.should_log' => 'array',
            'app-logger.performance.channel' => 'NULL',
            'app-logger.query.enabled' => 'boolean',
            'app-logger.query.log_profile' => 'string',
            'app-logger.query.log_writer' => 'string',
            'app-logger.query.channel' => 'NULL',
            'http-logger.enabled' => 'boolean',
            'http-logger.log_profile' => 'string',
            'http-logger.log_writer' => 'string',
            'http-logger.log_channel' => 'string',
            'http-logger.log_level' => 'string',
            'http-logger.except' => 'array',
            'http-logger.sanitize_headers' => 'array',
...
'database.connections.sqlsrv.prefix_indexes','database.connections.mongodb.driver','database.connections.mongodb.dsn','database.connections.mongodb.database','database.migrations.table',
...
'filesystems.links.C:\\project-git\\lapi\\public\\storage','jwt.secret','jwt.keys.public','jwt.keys.private','jwt.keys.passphrase',
...
'queue.batching.table','queue.failed.driver','queue.failed.database','queue.failed.table','request-docs.title',
'request-docs.enabled','request-docs.debug','request-docs.url','request-docs.middlewares','request-docs.only_route_uri_start_with',
'request-docs.hide_matching','request-docs.hide_meta_data','request-docs.hide_sql_data','request-docs.hide_logs_data','request-docs.hide_models_data',
'request-docs.rules_methods','request-docs.default_responses','request-docs.default_headers.Content-Type','request-docs.default_headers.Accept','request-docs.group_by.uri_patterns',
'request-docs.open_api.title','request-docs.open_api.description','request-docs.open_api.version','request-docs.open_api.document_version','request-docs.open_api.license',
'request-docs.open_api.license_url','request-docs.open_api.server_url','request-docs.open_api.delete_with_body','request-docs.open_api.exclude_http_methods','request-docs.open_api.responses.200.description',
'request-docs.open_api.responses.200.content.application/json.schema.type','request-docs.open_api.responses.400.description','request-docs.open_api.responses.400.content.application/json.schema.type','request-docs.open_api.responses.401.description','request-docs.open_api.responses.401.content.application/json.schema.type',
'request-docs.open_api.responses.403.description','request-docs.open_api.responses.403.content.application/json.schema.type','request-docs.open_api.responses.404.description','request-docs.open_api.responses.404.content.application/json.schema.type','request-docs.open_api.responses.422.description',
'request-docs.open_api.responses.422.content.application/json.schema.type','request-docs.open_api.responses.500.description','request-docs.open_api.responses.500.content.application/json.schema.type','request-docs.open_api.responses.default.description','request-docs.open_api.responses.default.content.application/json.schema.type',
'request-docs.open_api.security.type','request-docs.open_api.security.name','request-docs.open_api.security.position','request-docs.export_path','sanctum.stateful',
...
'hashing.rehash_on_login','view.paths','view.compiled','app-logger.http.enabled','app-logger.http.log_profile',
'app-logger.http.log_writer','app-logger.http.should_log','app-logger.http.except','app-logger.http.channel','app-logger.performance.enabled',
'app-logger.performance.log_profile','app-logger.performance.log_writer','app-logger.performance.should_log','app-logger.performance.channel','app-logger.query.enabled',
'app-logger.query.log_profile','app-logger.query.log_writer','app-logger.query.channel','http-logger.enabled','http-logger.log_profile',
'http-logger.log_writer','http-logger.log_channel','http-logger.log_level','http-logger.except','http-logger.sanitize_headers',
...
'request-docs.index','request-docs.api','request-docs.config','request-docs.assets','ai-tools.index','ai-tools.store','ai-tools.show',
'ai-tools.update','ai-tools.destroy','roles.index',
'roles.store','roles.show','roles.update','roles.destroy','storage.local',);
...
'pagination::tailwind','request-docs::index','telescope::layout',);
...
'LOG_LEVEL','USE_MONGO_USER_MODEL','DB_CONNECTION','DB_HOST','DB_PORT',
...
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','JWT_SECRET','MONGO_DB_URI','MONGO_DB_NAME',
'NEXT_PUBLIC_OPENAI_API_KEY','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URI',);
